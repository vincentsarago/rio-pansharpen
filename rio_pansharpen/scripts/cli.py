...
@click.option("--dst-dtype", type=click.Choice(["uint16", "uint8"]), default="uint8")
...
@click.option(
    ...
    "-c",
    default=0,
    help="Specify blocksize for custom windows > 150" "[default=src_blockswindows]",
)
@click.option(
    "--out-alpha/--no-out-alpha",
    default=True,
    is_flag=True,
